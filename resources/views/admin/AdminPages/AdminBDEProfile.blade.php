...
@section('content')
    ...
    <div class='card card-profile text-center' >
        ...
        <div class='card-block'>
            <img alt='' class='card-img-profile' src="images/{{$BDEById['image']}}">

            <h4 class='card-title'>
                <h4>{{ $BDEById['name'] }}</h4>
                <small>{{ $BDEById['email'] }}</small>
            </h4>

            <p>Address: {{$BDEById['address']}}</p>

            <p>Contact Number: {{$BDEById['phone']}}</p>
            
            <p>Not Interested: {{$Interested}}</p>
